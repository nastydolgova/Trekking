let PRODUCTS_NAMES = ['T-shirt', 'Pants FORCLAZ', 'backpack', 'Pr4', 'Pr5', 'pr6']
let PRICES = [5,30,60,5,5,5]
let IDS = [0, 1, 2, 3, 4,5]
let IMG = ['/img/Livello_2.png','/img/Livello_3.png','/img/Livello_4.png', '/img/Livello_2.png', '/img/Livello_2.png', '/img/Livello_2.png']
